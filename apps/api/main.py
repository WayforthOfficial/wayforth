...
@app.get("/webhooks/wri-alerts", tags=["Webhooks"])
@limiter.limit("30/minute")
...
@app.delete("/webhooks/wri-alerts/{alert_id}", tags=["Webhooks"])
@limiter.limit("20/minute")
...
@app.post("/provider/register", tags=["Provider"])
@limiter.limit("10/minute")
...
@app.post("/provider/login", tags=["Provider"])
@limiter.limit("20/minute")
...
@app.post("/provider/verify", tags=["Provider"])
@limiter.limit("10/minute")
...
@app.get("/provider/me", tags=["Provider"])
@limiter.limit("60/minute")
...
@app.get("/provider/overview", tags=["Provider"])
@limiter.limit("30/minute")
...
@app.get("/provider/queries", tags=["Provider"])
@limiter.limit("30/minute")
...
@app.get("/provider/competitors", tags=["Provider"])
@limiter.limit("30/minute")
...
@app.get("/provider/performance", tags=["Provider"])
@limiter.limit("30/minute")
...
@app.get("/provider/agents", tags=["Provider"])
@limiter.limit("30/minute")
...
@app.post("/provider/billing/upgrade", tags=["Provider"])
@limiter.limit("10/minute")
