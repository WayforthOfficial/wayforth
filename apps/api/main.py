...
# ── TEMP: SEED V8 (remove after run) ─────────────────────────────────────────

@app.post("/admin/run-seed-v8")
async def run_seed_v8(request: Request, db=Depends(get_db)):
    ...
    for svc in SERVICES_V8:
        ...
        if existing:
            ...
            await db.execute("""
                ...
                VALUES ($1, $2, $3, $4, $5, $6, 2, 'curated_v8', NOW())
    ...
    real_apis = await db.fetchval("""
        ...
        AND endpoint_url NOT ILIKE '%smithery%'
    """)
    return {"added": added, "skipped": skipped, "total": total, "tier2": tier2, "real_apis": real_apis}
