...
@app.post("/admin/run-seed-v7")
async def run_seed_v7(request: Request, db=Depends(get_db)):
    ...
    SERVICES_V7 = [
        ...
        {"name": "CoinGecko API", "description": "Free crypto market data. Prices, market cap, volume for 10,000+ coins. No API key required.", "endpoint_url": "https://api.coingecko.com/api/v3", "category": "data", "pricing_usdc": 0.0, "payment_protocol": "wayforth"},
        ...
        {"name": "Guardian API", "description": "Full-text access to The Guardian newspaper. 2M+ articles since 1999.", "endpoint_url": "https://content.guardianapis.com", "category": "data", "pricing_usdc": 0.0, "payment_protocol": "wayforth"},
