...
**What's live:**
- 2,463 services indexed across 7 categories (inference, data, translation, image, code, audio, embeddings)
- 115 Tier 2 verified — automated 90%+ uptime check, probed every 6 hours, auto-demoted on failure
