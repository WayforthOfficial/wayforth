...
**What's live:**
- 2,394 services indexed across 7 categories (inference, data, translation, image, code, audio, embeddings)
- 24+ Tier 2 verified — automated 90%+ uptime check, probed every 6 hours, auto-demoted on failure
